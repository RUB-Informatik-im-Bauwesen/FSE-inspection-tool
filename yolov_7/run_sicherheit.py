...
def run(
    ...
    names = ['Brandmelder-Schild', 'Brandmeldetelefon-Schild', 'Feuerleiter-Schild', 'Feuerloescher-Schild', 'Loeschschlauch-Schild', 'Mittel-Brandbekaempfung-Schild', 'Notausgang-Schild']
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                for c in det[:, -1].unique():
                    ...
                    print(f"Detected class index (c): {c}")
                    print(f"Class labels (names): {names}")
                ...
                for (*xyxy, conf, cls) in det:
                    ...
                    cropped_image_path = save_dir.parent / f'{class_name}_{class_obj_count[class_name]}_results.jpg'
            ...
            if save_json and json_data_list:
                ...
                with open(json_file_path, 'w') as json_file:
                    json.dump({'info': {'description': 'Result of Service-205', 'version': '0.0.2'},
